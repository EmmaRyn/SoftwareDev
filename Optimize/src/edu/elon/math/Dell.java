 ...
 * 
 */
public class Dell extends Function implements Remote {
  ...
  public Double evaluate() throws RemoteException {
    double x1;
      x1 = getInputValues().get(0).doubleValue();
      double y1 = getInputValues().get(1).doubleValue();
      double[] cost =
                    { 7.9, 25, 13.1, 17.4, 19.5, 13, 17.8, 8.0, 9.2, 6.3, 42.0, 6.6 };
